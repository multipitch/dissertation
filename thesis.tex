...
\author{Sean Tully, MA (\emph{Cantab.}), MEng}
...
completed once the main body of the dissertation is complete.  It will contain
a high-level overview of the work done in simple, plain language.
%%\end{abstract}
...
\bibliographystyle{mscBA1} % the BibTeX style file to use %was mscBA
