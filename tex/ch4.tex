...
\begin{figure}
    \centering
    \includegraphics[angle=0,scale=0.8]{./figures/plot2.pdf}
...
The source code may be cheked out from github by running:
...
\begin{itemize}
    \item \texttt{model.py} contains the model
    \item \texttt{plots.py} contains code for genrating various plots
...
The \texttt{model.py} file contains the following functions:
\begin{itemize}
...
The \texttt{unflatten\_variable} varaible function essentially performs the
...
\subsection{Executable}\label{SS.plotcode}
